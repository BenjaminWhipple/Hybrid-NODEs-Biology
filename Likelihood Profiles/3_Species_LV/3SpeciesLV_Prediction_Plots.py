...
for i in range(REPLICATES):
    ...
    UNKNOWN_HYBRID_MODELS.append(torch.load(f"Experiments/3Species_LV_UnknownParamHybrid/3Species_LV_UnknownParamHybrid_{NETWORK_SIZE}_{UNKNOWN_HYBRID_RES_BEST[i]-1}.pt"))
...
#plt.tight_layout()
plt.savefig("3Species_LV_PREDICT.pdf")
