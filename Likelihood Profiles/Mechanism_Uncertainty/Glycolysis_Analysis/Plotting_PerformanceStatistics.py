...
KnownHybrid_Results = pd.read_csv("Experiments/Glycolysis_KnownParamHybrid_Results.csv")
UnknownHybrid_Results = pd.read_csv("Experiments/Glycolysis_UnknownParamHybrid_Results.csv")
NODE_Results = pd.read_csv("Experiments/Glycolysis_NODE_Results.csv")
...
ax.set_yscale("log")
ax.set_title("Median Performance of Models on Glycolysis")
...
#plt.tight_layout()
fig.savefig("GlycolysisModelPerformance.pdf")
