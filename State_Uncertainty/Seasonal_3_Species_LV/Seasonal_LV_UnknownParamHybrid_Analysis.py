...
model = unknownhybridODE(p,(4,1,[5,5])).to(device)
...
for it in range(1, niters + 1):
    ...
    #loss = MAE + L1_Reg
    loss = torch.mean(torch.abs(pred_y[:,:,:,:-2] - batch_y))
...
plt.savefig('Seasonal_LV_testing_UnknownParamHybrid.png')
#test_pred = 
