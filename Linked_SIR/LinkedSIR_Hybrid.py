...
for size in sizes:
    for replicate in range(replicates):
        ...
        torch.save(model,f'Experiments/KnownParam_Hybrid/KnownHybrid_{size}_{replicate}_data.pt')

df = pd.DataFrame({"Train Loss":Train, "Test Loss": Test, "Replicate": Replicates, "Size":Size_Record, "Attempts":Attempts})

df.to_csv("Experiments/KnownParam_Hybrid_Results.csv",index=False)
"""
