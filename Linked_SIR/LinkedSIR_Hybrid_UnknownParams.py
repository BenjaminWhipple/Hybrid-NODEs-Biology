...
class hybridODE(nn.Module):
    ...
    def __init__(self, p0,structure):
        ...
        self.beta1 = self.paramsODE[0]
        self.beta2 = self.paramsODE[1]
        self.gamma1 = self.paramsODE[2]
        self.gamma2 = self.paramsODE[3]
...
model = hybridODE([0.1,0.1,0.1,0.1],(6,6,[10,10])).to(device)
